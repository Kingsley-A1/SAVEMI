  ...
  try {
    const updated = await prisma.book.update({
      ...
      data: {
        ...
        ...(downloadKey !== undefined && { downloadKey: typeof downloadKey === "string" ? downloadKey || null : null }),
        ...(downloadFileName !== undefined && { downloadFileName: typeof downloadFileName === "string" ? downloadFileName || null : null }),
